    ...
    <section className="mx-auto max-w-3xl px-6 py-24 lg:py-32">
      ...
      <div className="mt-10 space-y-6 text-brand-black/80">
        ...
        <p>
          ...
          Grundfunktionen bereitzustellen. Es werden keine Cookies zu Analyse- oder Marketingzwecken
          gesetzt.
        </p>
        ...
        <p>
          ...
          Verarbeitung Ihrer gespeicherten Daten. Bitte wenden Sie sich hierzu an{" "}
        ...
        <p>
          Beim Besuch dieser Website erfasst unser Hoster automatisch anonymisierte Server-Logfiles
          (IP-Adresse, Datum, Uhrzeit, aufgerufene Seite). Diese Daten dienen ausschließlich der
